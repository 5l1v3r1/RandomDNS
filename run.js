...
class RandomDNS {
    ...
    constructor() {
        ...
        cli.version(require('./package.json').version)
            ...
            .option('--reverseProxyChildStartPort [int]', 'Where childrens (dnscrypt-proxy processes) should start incrementing the port? [default: 51000]', 51000)
            ...
            .option('-b, --binaryEdgeDNSFile [string]', 'Use custom EdgeDNS binary, will not work until --binaryEdgeDNSFileSignature is changed.', '/Users/sabri/Desktop/Repositories/RandomDNS/edgedns/edgedns')
